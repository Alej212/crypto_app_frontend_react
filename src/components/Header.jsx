export default function Header() {
  ...
  return (
    <nav className="md:flex justify-between items-center pl-20 pr-20 bg-slate-900 bg-opacity-90 h-24 font-bold border-b-4 border-teal-400 fixed top-0 w-full z-20 hidden">
